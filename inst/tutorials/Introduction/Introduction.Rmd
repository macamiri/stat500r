...
This concludes our section on cmpaing two population variances. Next, we will discuss how to use the Chi-Squared test when both the response and the explanatory variable are qualitative.

## Lesson 8

Chi squared

### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 7.1: Contingency Table


```{r chi-sq, exercise = TRUE, exercise.eval = FALSE, exercise.startover = TRUE}
# Ho: p1 = p2 vs Ha: p1 ≠ p2
