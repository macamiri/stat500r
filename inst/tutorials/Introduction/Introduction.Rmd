...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 6.1: Hypothesis Testing for 1 Sample Proportion
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 6.1: Hypothesis Testing for 1 Sample Mean
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 7.1: Comparing Two Population Proportions
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 7.2: Comparing Two Population Means (Independent)
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 7.3: Comparing Two Population Means (Paired)
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 7.4: Comparing Two Population Variances
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 8.1: Contingency Table
...
grocery_table %>% 
  ...
  labs(x = "Household Size", y = "Frequency", title = "Payment Methods Preferred\nby Household Size") + 
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 8.2: Chi-Square Test
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 8.3: Final Plot
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 9.1: Correlation Coefficients
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 9.2: Correlation Test
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 9.3: Correlation
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 9.4: Simple Linear Regression
...
Focus your attention on the coefficients part of the output: `r cat(crayon::bold("mpg = -.06823 * hp + 30.09886"))`. This means that on average, as horse power increases by 1 unit, the car's miles per gallon decreases by .068.
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 10.1: Data Preparation
...
grandiose %>% 
  ...
  labs(x = "Store", y = "Price", title = ("Products Prices:\nTop 3 Grandiose Stores")) +
  hrbrthemes::theme_ipsum(grid = "Y") + 
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 10.2: ANOVA
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 10.3: ANOVA Assumptions
...
### `r fa("fas fa-lightbulb", fill = "#08192B")` Code 10.3: Post-hoc Tests
...
Congratulations! You have made it to the end of this tutorial and course. Good luck on your final exam. 

### what next?
### edit aesthetics (dark code blocks, color headings)

Remember that you can always visit this tutorial by running the following command in your R console: `learnr::run_tutorial("introduction", "stat500r")`
